...
// const htcrawl = require("/Users/gauravnarwani/tools/htcrawl/main.js");
// /Users/gauravnarwani/Downloads/htcrawl-developer/main.js 
const htcrawl = require("G:/Downloads/htcrawl-developer copy (1)/htcrawl-developer copy/main.js");
// const htcrawl = require("htcrawl");
const utils = require('./utils-analyze');
...
(async () => {
	...
	crawler.on("xhrCompleted", function(e, crawler){
		...
		// utils.printRequest(e.params.request)
		// console.log(e.params.response)
		// console.log(e.params.timedout)
	});
