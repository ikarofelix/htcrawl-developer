...
exports.options = {
	...
	searchUrls: true,
	jsonOutput:true,
	maxExecTime: 1000000, // 300 seconds - remove me!
	ajaxTimeout:3000,
	...
	eventsMap: {
		'button':['click','mouseover'],
		'select':['change','click','mouseover'],
		'input':['change','click','mouseover'],
		'a':['click','mouseover'],
		'textarea':['change','click','blur','focus'],
		'span':['click'],
		'div':['click']
		// 'form':['submit']
	},
